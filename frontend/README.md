...
**If you get any error related to sass, use the following command**
...
**Please use the following command in terminal to avoid error 'ERR_OSSL_EVP_UNSUPPORTED'**
```bash
...
## Key Changes made
1. `./src/environments/environment.ts` - Important changes for auth0
2. `./src/app/pages/drink-menu/drink-form/drink-form.component.html` - few changes to limit access to Barista in Editing the recipe
